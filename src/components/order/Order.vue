    ...
    <el-card>
      ...
      <el-table :data="orderlist" style="width: 100%" border stripe>
        ...
        <el-table-column label="操作" width="180px">
          <template>
          <!-- 修改地址 -->
          <el-button class="btn" type="primary" icon="el-icon-edit" size="mini" @click="showBox"></el-button>
          <!-- 查看物流信息 -->
          <el-button class="btn" type="success" icon="el-icon-location" size="mini" @click="showProgressBox"></el-button>
          </template>
        </el-table-column>
      </el-table>
